...
<body>
	<jsp:include page="/WEB-INF/views/common/header.jsp"/>
        ...
        <br clear="both">
        <form id="searchForm" method="get" align="center" action="${boardCode }" style="display: flex; align-items: center; gap: 10px" flex-wrap="nowrap;">
            <div class="select">
            ...
            <button type="submit" class="searchBtn btn btn-secondary" style="white-space: nowrap;">검색</button>
            <!-- 로그인한 사용자만 보이게 데이터 바인딩 -->
            <sec:authorize access="isAuthenticated()">
            <a class="btn btn-secondary"
            href="${contextPath }/board/insert/${boardCode}" style="white-space: nowrap;">글쓰기</a>
            </sec:authorize>	
