	...
	<div class="content">
		...
		<div class="innerOuter">
			...
			<form:form modelAttribute="board"
				action="${contextPath }/board/update/${boardCode}/${boardNo}"
					...
					<c:if test="${boardCode eq 'P'}">
						<%-- <c:if test="${not empty board.imgList }">
							<c:forEach items="${board.imgList }" var="boardImg" varStatus="i">
								...
								<td><img class="preview" src="${contextPath }${boardImg.changeName}"> <input
									type="file" name="upfile" class="form-control inputImage"
									accept="images/*" id="img${i }"> <span class="delete-image"
									data-no="${boardImg.boardImgNo}">&times;</span> <input type="hidden"
