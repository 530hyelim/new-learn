	...
	<div class="modal-dialog">
   		<div class="modal-content">
   			...
   			<c:if test="${not empty event}">
	   			<form:form modelAttribute="event" method="post" action="${pageContext.request.contextPath}/event/dml">
	       			<div class="modal-body">
		       			<form:input path="eventNo" type="hidden"/>
	       				<form:input path="eventType" type="hidden" value="PERSONAL"/>
					    ...
					    세부내용 <form:textarea path="content" required="required"/>
	       			</div>
